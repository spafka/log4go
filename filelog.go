...
const DefalutLogConfig = "{\"console\":{\"enable\":true,\"level\":\"DEBUG\",\"pattern\":\"[%D %T] [%C] [%L] (%S) %M\"},\"files\":[{\"enable\":true,\"level\":\"DEBUG\",\"filename\":\"console.log\",\"pattern\":\"[%D %T] [%C] [%L] (%S) %M\",\"category\":\"DEFAULT\",\"rotate\":true,\"maxsize\":\"10G\",\"maxlines\":\"10G\",\"daily\":true,\"maxdate\":\"90\"}]}"
	...
	if w.rotate {
		...
		if err == nil { // file exists
			...
			if w.daily && time.Now().Day() != w.daily_opendate {
				...
				fmt.Println("try 2 delete ", date2deletename)
